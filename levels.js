...
export class Level1 extends Level {
    constructor(canvas, play) {
        ...
        this.background = [
            ...
            new Background("./Background/level1/layer-3.png", canvas, play, 0.2),
            new Background("./Background/level1/layer-4.png", canvas, play, 0.4),
            new Background("./Background/level1/layer-5.png", canvas, play, 0.6),
...
export class Level2 extends Level {
    constructor(canvas, play) {
        super(canvas, play)
        this.background = [
            new Background("./Background/level2/layer-1.png", canvas, play, 0),
            new Background("./Background/level2/layer-2.png", canvas, play, 0.2),
            new Background("./Background/level2/layer-3.png", canvas, play, 0.4),
            new Background("./Background/level2/layer-4.png", canvas, play, 0.6),
            new Background("./Background/level2/layer-5.png", canvas, play, 0.9),
        ]
